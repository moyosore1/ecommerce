# Generated by Django 3.0.8 on 2020-08-10 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('pending', 'pending'), ('delivered', 'delivered')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='store.Category')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
